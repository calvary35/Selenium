...
public class waitsDemo {
    public static void main(String[] args) {
        ...
        //as the button appears up after some time so in order to click it or get text from it we need to define
        //some explicit time

        WebDriverWait wait = new WebDriverWait(driver,20);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@id='hidden']")));

        WebElement visibileBTN = driver.findElement(By.xpath("//button[@id='hidden']"));
        visibileBTN.click();
